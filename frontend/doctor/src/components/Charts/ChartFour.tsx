            ...
            <section>
                <div className="flex m-4 gap-2">
                    <div className="flex-1 px-2 justify-center w-16 bg-gray-700 shadow rounded h-300px">
                        <div className="">
                            <p className="text-gray-900 font-bold">Số bệnh nhân</p>
                            <p className="py-4 font-bold">100 </p>
                            <p className="text-green-300">+34.5%</p>
                        </div>
                    </div>
                    <div className="flex-1 px-2 justify-center w-16 bg-gray-700 shadow rounded max-h-300px">
                        <div className="">
                            <p className="text-gray-900 font-bold">Tổng tiền khám</p>
                    ...
                    <div className="flex-1 px-2 justify-center w-16  bg-gray-700 shadow rounded max-h-300px">
                        <div className="">
                            <p className="text-gray-900 font-bold">Trung bình đánh giá</p>
                            <p className="py-4 font-bold">5 Sao </p>
                            <p className="text-green-300">+34.5%</p>
                        </div>
                    </div>
                    <div className="flex-1 px-2 justify-center w-16  bg-gray-700 shadow rounded h-300px">
                        <div className="">
                            <p className="text-gray-900 font-bold">Tổng lượt khám / ngày</p>
                            <p className="py-4 font-bold ">10 </p>
                            <p className="text-green-300">+34.5%</p>
                        </div>
                    </div>
                </div>
